...
from maps.graph_edges.glitched_logic.omo_anti_guy_skip import (
    edges_omo_add_anti_guy_skip,
)
...
def get_glitched_logic(
    ...
    if glitch_settings.anti_guy_skip:
        all_new_edges.extend(edges_omo_add_anti_guy_skip)
