...
edges_sbk = [
    ...
    {"from": {"map": "SBK_00", "id": "YBlockA"}, "to": {"map": "SBK_00", "id": "YBlockB"}, "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockB (Coin)
    ...
    {"from": {"map": "SBK_06", "id": 0}, "to": {"map": "SBK_06", "id": "RandomBlockItemA"}, "reqs": [["can_hit_floating_blocks"]]}, #* N3E3 Exit West -> RandomBlockItemA (CoinBag)
    ...
    {"from": {"map": "SBK_10", "id": 1}, "to": {"map": "SBK_10", "id": "HiddenYBlockA"}, "reqs": [["can_see_hidden_blocks"],["can_hit_floating_blocks"],["can_climb_steps"]]}, #* N2W3 Exit East -> HiddenYBlockA (ThunderRage)
    ...
    {"from": {"map": "SBK_14", "id": "YBlockA"}, "to": {"map": "SBK_14", "id": "YBlockB"},          "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockB (HoneySyrup)
    {"from": {"map": "SBK_14", "id": 0},         "to": {"map": "SBK_14", "id": "RandomBlockItemA"}, "reqs": [["can_hit_floating_blocks"]]}, #* N2E1 (Tweester A) -> RandomBlockItemA (CoinBag)
    ...
    {"from": {"map": "SBK_20", "id": 1},         "to": {"map": "SBK_20", "id": "YBlockA"}, "reqs": [["can_hit_grounded_blocks"],["can_hit_floating_blocks"]]}, #* N1W3 Special Block Exit East -> YBlockA (Mushroom)
    {"from": {"map": "SBK_20", "id": "YBlockA"}, "to": {"map": "SBK_20", "id": "YBlockB"}, "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockB (SuperShroom)
    {"from": {"map": "SBK_20", "id": "YBlockA"}, "to": {"map": "SBK_20", "id": "YBlockC"}, "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockC (UltraShroom)
    ...
    {"from": {"map": "SBK_22", "id": "YBlockA"}, "to": {"map": "SBK_22", "id": "YBlockB"}, "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockB (Coin)
    {"from": {"map": "SBK_22", "id": "YBlockA"}, "to": {"map": "SBK_22", "id": "YBlockC"}, "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockC (Coin)
    {"from": {"map": "SBK_22", "id": "YBlockA"}, "to": {"map": "SBK_22", "id": "YBlockD"}, "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockD (Coin)
    {"from": {"map": "SBK_22", "id": "YBlockA"}, "to": {"map": "SBK_22", "id": "YBlockE"}, "reqs": []}, #+ SHARED REQUIREMENTS -> YBlockE (FireFlower)
    ...
    {"from": {"map": "SBK_24", "id": 0}, "to": {"map": "SBK_24", "id": "HiddenRBlockA"}, "reqs": [["can_see_hidden_blocks"],["can_hit_floating_blocks"]]}, #* N1E1 Palm Trio Exit West -> HiddenRBlockA (RunawayPay)
    ...
    {"from": {"map": "SBK_25", "id": 0}, "to": {"map": "SBK_25", "id": "RandomBlockItemA"}, "reqs": [["can_hit_floating_blocks"]]}, #* N1E2 Exit West -> RandomBlockItemA (CoinBag)
    {"from": {"map": "SBK_25", "id": 0}, "to": {"map": "SBK_25", "id": "RandomBlockItemB"}, "reqs": [["can_hit_floating_blocks"]]}, #* N1E2 Exit West -> RandomBlockItemB (CoinBag)
    ...
    {"from": {"map": "SBK_40", "id": 1}, "to": {"map": "SBK_40", "id": "RandomBlockItemA"}, "reqs": [["can_hit_floating_blocks"]]}, #* S1W3 Exit East -> RandomBlockItemA (CoinBag)
    ...
    {"from": {"map": "SBK_45", "id": 0}, "to": {"map": "SBK_45", "id": "ItemA"}, "reqs": [["Kooper","UltraBoots"],["can_climb_steps","UltraBoots"]]}, #* S1E2 Small Bluffs Exit West -> ItemA (StopWatch)
    ...
    {"from": {"map": "SBK_52", "id": 0}, "to": {"map": "SBK_52", "id": "RandomBlockItemA"}, "reqs": [["can_hit_floating_blocks"]]}, #* S2W1 Exit West -> RandomBlockItemA (CoinBag)
    ...
    {"from": {"map": "SBK_55", "id": 0}, "to": {"map": "SBK_55", "id": "RandomBlockItemA"}, "reqs": [["can_hit_floating_blocks"]]}, #* S2E2 West of Oasis Exit West -> RandomBlockItemA (CoinBag)
    ...
    {"from": {"map": "SBK_56", "id": 0},              "to": {"map": "SBK_56", "id": "RandomBlockItemA"}, "reqs": [["can_hit_floating_blocks"]]}, #* S2E3 Oasis Exit West -> RandomBlockItemA (GenericUpgrade)
    ...
    {"from": {"map": "SBK_61", "id": 0}, "to": {"map": "SBK_61", "id": "HiddenRBlockA"}, "reqs": [["can_see_hidden_blocks"],["can_hit_floating_blocks"],["can_climb_steps"]]}, #* S3W2 Hidden AttackFX Exit West -> HiddenRBlockA (AttackFXC)
