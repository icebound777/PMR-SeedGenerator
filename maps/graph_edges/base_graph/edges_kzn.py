...
edges_kzn = [
    ...
    {"from": {"map": "KZN_19", "id": 1},         "to": {"map": "KZN_19", "id": "BossReward"}, "reqs": [["MF_Ch5_FoundEscapeRoute"]], "pseudoitems": ["MF_Ch5_RescuedStarSpirit"]}, #* Boss Room Exit West Lower -> BossReward (Misstar)
