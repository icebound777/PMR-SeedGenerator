...
edges_trd = [
    ...
    {"from": {"map": "TRD_10", "id": 0}, "to": {"map": "TRD_10", "id": "BossReward"}, "reqs": [["Hammer","Bombette","Watt"]], "pseudoitems": ["MF_Ch1_RescuedStarSpirit"]}, #* Boss Battle Room Exit Left -> BossReward (Eldstar)
]
