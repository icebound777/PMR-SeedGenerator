...
edges_dro = [
    ...
    {"from": {"map": "DRO_02", "id": 0}, "to": {"map": "DRO_02", "id": "HiddenPanel"}, "reqs": [["can_flip_panels"],["RF_CanMeetMoustafa"],["Boots"]]}, #* Outpost 2 Exit West -> HiddenPanel (StarPiece)
    {"from": {"map": "DRO_02", "id": 0}, "to": {"map": "DRO_02", "id": "ItemA"},       "reqs": [["RF_CanMeetMoustafa"],["Boots"]]}, #* Outpost 2 Exit West -> ItemA (Letter08)
