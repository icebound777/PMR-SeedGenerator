...
edges_kpa = [
    ...
    {"from": {"map": "KPA_81",  "id": 0}, "to": {"map": "KPA_81",  "id": 1}, "reqs": [["Bombette"], ["Lakilester"], ["Parakarry"], ["Bow"], ["Watt","RF_WattlessBasement"]]}, #? Guard Door 1 Door Left -> Guard Door 1 Fall In Trap Door
