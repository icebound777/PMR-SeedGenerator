...
edges_kmr_tik_isk_add_break_stone_blocks_ultra_boots = [
    ...
    {"from": {"map": "KMR_03", "id": 1}, "to": {"map": "KMR_03", "id": "HiddenYBlockA"}, "reqs": [["UltraBoots"],["can_see_hidden_blocks"]], "mapchange": False},
    ...
    #* Sand Drainage Room 3 Exit Top Left -> ItemA (RuinsKey)
    {"from": {"map": "ISK_12", "id": 1}, "to": {"map": "ISK_12", "id": "ItemA"}, "reqs": [["UltraBoots"]],  "mapchange": False},
]
