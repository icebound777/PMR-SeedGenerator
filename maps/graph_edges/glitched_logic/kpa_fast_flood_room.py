...
edges_kpa_add_fast_flood_room_kooper = [
    ...
    {"from": {"map": "KPA_133", "id": 2}, "to": {"map": "KPA_133", "id": 3}, "reqs": [["Lakilester"],["Bombette"]], "mapchange": False},
    ...
    {"from": {"map": "KPA_134", "id": 0}, "to": {"map": "KPA_134", "id": 2}, "reqs": [["Lakilester"]], "mapchange": False},
    #? Right Water Puzzle Door Bottom Left Upper Half -> Right Water Puzzle Door Bottom Left
    {"from": {"map": "KPA_134", "id": 2}, "to": {"map": "KPA_134", "id": 0}, "reqs": [["Lakilester"]], "mapchange": False},
]
