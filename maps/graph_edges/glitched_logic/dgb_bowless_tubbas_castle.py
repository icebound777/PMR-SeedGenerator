...
edges_dgb_add_bowless_tubbas_castle = [
    #? Great Hall Door 1F Bottom -> Great Hall Door Door 1F Left
    {"from": {"map": "DGB_01", "id": 0}, "to": {"map": "DGB_01", "id": 1}, "reqs": [], "mapchange": False},
    #? Great Hall Door 1F Bottom -> Great Hall Door Door 1F Right
    ...
    {"from": {"map": "DGB_12", "id": 0}, "to": {"map": "DGB_12", "id": "ChestA"}, "reqs": [["SpeedySpin"]], "mapchange": False},
]
