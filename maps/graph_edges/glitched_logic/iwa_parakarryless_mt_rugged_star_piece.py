...
edges_iwa_add_parakarryless_star_piece_laki = [
    ...
    {"from": {"map": "IWA_03", "id": 0}, "to": {"map": "IWA_03", "id": "ItemC"}, "reqs": [["Lakilester"]], "mapchange": False},
    #* Mt Rugged 4 Exit Bottom Right -> ItemD (Coin)
    {"from": {"map": "IWA_03", "id": 0}, "to": {"map": "IWA_03", "id": "ItemD"}, "reqs": [["Lakilester"]], "mapchange": False},
    #* Mt Rugged 4 Exit Bottom Right -> ItemE (Coin)
    {"from": {"map": "IWA_03", "id": 0}, "to": {"map": "IWA_03", "id": "ItemE"}, "reqs": [["Lakilester"]], "mapchange": False},
    #* Mt Rugged 4 Exit Bottom Right -> ItemF (Coin)
    {"from": {"map": "IWA_03", "id": 0}, "to": {"map": "IWA_03", "id": "ItemF"}, "reqs": [["Lakilester"]], "mapchange": False},
    #* Mt Rugged 4 Exit Bottom Right -> ItemG (Coin)
    {"from": {"map": "IWA_03", "id": 0}, "to": {"map": "IWA_03", "id": "ItemG"}, "reqs": [["Lakilester"]], "mapchange": False},
    #* Mt Rugged 4 Exit Bottom Right -> ItemH (Coin)
    {"from": {"map": "IWA_03", "id": 0}, "to": {"map": "IWA_03", "id": "ItemH"}, "reqs": [["Lakilester"]], "mapchange": False},
]
