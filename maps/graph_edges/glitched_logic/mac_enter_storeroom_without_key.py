...
edges_mac_add_storeroom_without_key_parakarry = [
    ...
    {"from": {"map": "MAC_04", "id": 0}, "to": {"map": "MAC_04", "id": "ItemB"}, "reqs": [["Parakarry"]], "mapchange": False},
    #* Residental District Exit Right -> ItemC (ToyTrain)
    {"from": {"map": "MAC_04", "id": 0}, "to": {"map": "MAC_04", "id": "ItemC"}, "reqs": [["Parakarry"]], "mapchange": False},
    #* Residental District Exit Right -> ItemD (DizzyDial)
    {"from": {"map": "MAC_04", "id": 0}, "to": {"map": "MAC_04", "id": "ItemD"}, "reqs": [["Parakarry"]], "mapchange": False},
]
...
edges_mac_add_storeroom_without_key_hammer = [
    ...
    #* Residental District Exit Right -> ItemB (VoltShroom)
    {"from": {"map": "MAC_04", "id": 0}, "to": {"map": "MAC_04", "id": "ItemB"}, "reqs": [["Hammer"]], "mapchange": False},
    #* Residental District Exit Right -> ItemC (ToyTrain)
    {"from": {"map": "MAC_04", "id": 0}, "to": {"map": "MAC_04", "id": "ItemC"}, "reqs": [["Hammer"]], "mapchange": False},
    #* Residental District Exit Right -> ItemD (DizzyDial)
