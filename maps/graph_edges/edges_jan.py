...
edges_jan = [
    ...
    {"from": {"map": "JAN_11", "id": 0}, "to": {"map": "JAN_11", "id": 0}, "reqs": [require(flag="RF_YoshiKidsMissing"), require(partner="Watt",flag="RF_HiddenBlocksVisible")], "pseudoitems": ["RF_SavedYoshiKid"]}, #+ Save Yoshi Kid
