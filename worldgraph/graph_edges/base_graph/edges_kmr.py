...
edges_kmr  = [
    ...
    {"from": {"map": "KMR_04", "id": "Tree1_Drop1"}, "to": {"map": "KMR_04", "id": "Tree2_Drop1"},      "reqs": []}, #+ SHARED REQUIREMENTS -> Tree2_Drop1 (Coin)
    {"from": {"map": "KMR_04", "id": "Tree1_Drop1"}, "to": {"map": "KMR_04", "id": "Tree3_Drop1A"},     "reqs": []}, #+ SHARED REQUIREMENTS -> Tree3_Drop1A (Dolly)
