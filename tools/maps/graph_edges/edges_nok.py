...
edges_nok = [
    ...
    {"from": {"map": "NOK_01", "id": 0},               "to": {"map": "NOK_01", "id": "Bush6A_Drop1A"}, "reqs": []}, #* Koopa Village 1 Exit Left -> Bush6A_Drop1A (Glasses)
    {"from": {"map": "NOK_01", "id": "Bush6A_Drop1A"}, "to": {"map": "NOK_01", "id": 0},               "reqs": []}, #* Bush6A_Drop1A (Glasses) -> Koopa Village 1 Exit Left
    {"from": {"map": "NOK_01", "id": 0},               "to": {"map": "NOK_01", "id": "Bush7A_Drop1A"}, "reqs": []}, #* Koopa Village 1 Exit Left -> Bush7A_Drop1A (EmptyWallet)
    {"from": {"map": "NOK_01", "id": "Bush7A_Drop1A"}, "to": {"map": "NOK_01", "id": 0},               "reqs": []}, #* Bush7A_Drop1A (EmptyWallet) -> Koopa Village 1 Exit Left
    {"from": {"map": "NOK_01", "id": 0},               "to": {"map": "NOK_01", "id": "HiddenPanel"},   "reqs": []}, #* Koopa Village 1 Exit Left -> HiddenPanel (StarPiece)
    ...
    {"from": {"map": "NOK_02", "id": 0},       "to": {"map": "NOK_02", "id": "GiftA"}, "reqs": []}, #* Koopa Village 2 Exit Left -> GiftA (KoopaLegends)
    {"from": {"map": "NOK_02", "id": "GiftA"}, "to": {"map": "NOK_02", "id": 0},       "reqs": []}, #* GiftA (KoopaLegends) -> Koopa Village 2 Exit Left
    {"from": {"map": "NOK_02", "id": 0},       "to": {"map": "NOK_02", "id": "GiftB"}, "reqs": []}, #* Koopa Village 2 Exit Left -> GiftB (SilverCredit)
    {"from": {"map": "NOK_02", "id": "GiftB"}, "to": {"map": "NOK_02", "id": 0},       "reqs": []}, #* GiftB (SilverCredit) -> Koopa Village 2 Exit Left
    {"from": {"map": "NOK_02", "id": 0},       "to": {"map": "NOK_02", "id": "GiftC"}, "reqs": []}, #* Koopa Village 2 Exit Left -> GiftC (GoldCredit)
    ...
    {"from": {"map": "NOK_03", "id": 0},       "to": {"map": "NOK_03", "id": "ItemA"}, "reqs": []}, #* Behind Koopa Village Exit Left -> ItemA (HPPlusB)
    ...
    {"from": {"map": "NOK_12", "id": 1}, "to": {"map": "NOK_12", "id": "ItemA"}, "reqs": []}, #* Pleasant Path Bridge Exit Right -> ItemA (StarPiece)
    ...
    {"from": {"map": "NOK_13", "id": 0},             "to": {"map": "NOK_13", "id": "HiddenPanel"}, "reqs": []}, #* Pleasant Crossroads Exit Left -> HiddenPanel (StarPiece)
    ...
    {"from": {"map": "NOK_14", "id": 0},               "to": {"map": "NOK_14", "id": "HiddenPanel"},   "reqs": []}, #* Path to Fortress 1 Exit Left -> HiddenPanel (StarPiece)
    ...
    {"from": {"map": "NOK_14", "id": 0},               "to": {"map": "NOK_14", "id": "ItemF"},         "reqs": []}, #* Path to Fortress 1 Exit Left -> ItemF (ThunderBolt)
    ...
    {"from": {"map": "NOK_15", "id": 1}, "to": {"map": "NOK_15", "id": 3}, "reqs": []}, #? Path to Fortress 2 Exit Bottom Right -> Path to Fortress 2 Bottom Pipe
