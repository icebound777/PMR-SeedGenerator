...
edges_iwa = [
    ...
    {"from": {"map": "IWA_00", "id": 0},         "to": {"map": "IWA_00", "id": "ItemD"},   "reqs": []}, #* Mt Rugged 1 Exit Left -> ItemD (WhackasBump)
    ...
    {"from": {"map": "IWA_01", "id": 0},             "to": {"map": "IWA_01", "id": "HiddenPanel"}, "reqs": []}, #* Mt Rugged 2 Exit Bottom Left -> HiddenPanel (StarPiece)
    {"from": {"map": "IWA_01", "id": "HiddenPanel"}, "to": {"map": "IWA_01", "id": 0},             "reqs": []}, #* HiddenPanel (StarPiece) -> Mt Rugged 2 Exit Bottom Left
    {"from": {"map": "IWA_01", "id": 0},             "to": {"map": "IWA_01", "id": "ItemA"},       "reqs": []}, #* Mt Rugged 2 Exit Bottom Left -> ItemA (QuakeHammer)
    {"from": {"map": "IWA_01", "id": "ItemA"},       "to": {"map": "IWA_01", "id": 0},             "reqs": []}, #* ItemA (QuakeHammer) -> Mt Rugged 2 Exit Bottom Left
    {"from": {"map": "IWA_01", "id": 0},             "to": {"map": "IWA_01", "id": "ItemB"},       "reqs": []}, #* Mt Rugged 2 Exit Bottom Left -> ItemB (Letter01)
    ...
    {"from": {"map": "IWA_02", "id": 0},       "to": {"map": "IWA_02", "id": "GiftA"}, "reqs": []}, #* Mt Rugged 3 Exit Bottom Left -> GiftA (MagicalSeed2)
    ...
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "ItemB"},   "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> ItemB (StarPiece)
    {"from": {"map": "IWA_03", "id": "ItemB"},   "to": {"map": "IWA_03", "id": 0},         "reqs": []}, #* ItemB (StarPiece) -> Mt Rugged 4 Exit Bottom Right
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "ItemC"},   "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> ItemC (Coin) (circle-right)
    {"from": {"map": "IWA_03", "id": "ItemC"},   "to": {"map": "IWA_03", "id": 0},         "reqs": []}, #* ItemC (Coin) -> Mt Rugged 4 Exit Bottom Right
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "ItemD"},   "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> ItemD (Coin)
    {"from": {"map": "IWA_03", "id": "ItemD"},   "to": {"map": "IWA_03", "id": 0},         "reqs": []}, #* ItemD (Coin) -> Mt Rugged 4 Exit Bottom Right
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "ItemE"},   "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> ItemE (Coin)
    {"from": {"map": "IWA_03", "id": "ItemE"},   "to": {"map": "IWA_03", "id": 0},         "reqs": []}, #* ItemE (Coin) -> Mt Rugged 4 Exit Bottom Right
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "ItemF"},   "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> ItemF (Coin)
    {"from": {"map": "IWA_03", "id": "ItemF"},   "to": {"map": "IWA_03", "id": 0},         "reqs": []}, #* ItemF (Coin) -> Mt Rugged 4 Exit Bottom Right
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "ItemG"},   "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> ItemG (Coin)
    {"from": {"map": "IWA_03", "id": "ItemG"},   "to": {"map": "IWA_03", "id": 0},         "reqs": []}, #* ItemG (Coin) -> Mt Rugged 4 Exit Bottom Right
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "ItemH"},   "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> ItemH (Coin)
    ...
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "YBlockA"}, "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> YBlockA (Coin)
    ...
    {"from": {"map": "IWA_03", "id": 0},         "to": {"map": "IWA_03", "id": "YBlockC"}, "reqs": []}, #* Mt Rugged 4 Exit Bottom Right -> YBlockC (HoneySyrup)
