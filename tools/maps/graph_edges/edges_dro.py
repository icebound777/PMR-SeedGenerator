...
edges_dro = [
    ...
    {"from": {"map": "DRO_02", "id": 0},             "to": {"map": "DRO_01", "id": "GiftA"},       "reqs": []}, #* Outpost 2 Exit West -> GiftA (CrystalBall)
    {"from": {"map": "DRO_02", "id": "GiftA"},       "to": {"map": "DRO_01", "id": 0},             "reqs": []}, #* GiftA (CrystalBall) -> Outpost 2 Exit West
    {"from": {"map": "DRO_02", "id": 0},             "to": {"map": "DRO_01", "id": "GiftB"},       "reqs": []}, #* Outpost 2 Exit West -> GiftB (PulseStone)
    {"from": {"map": "DRO_02", "id": "GiftB"},       "to": {"map": "DRO_01", "id": 0},             "reqs": []}, #* GiftB (PulseStone) -> Outpost 2 Exit West
    {"from": {"map": "DRO_02", "id": 0},             "to": {"map": "DRO_01", "id": "HiddenPanel"}, "reqs": []}, #* Outpost 2 Exit West -> HiddenPanel (StarPiece)
    {"from": {"map": "DRO_02", "id": "HiddenPanel"}, "to": {"map": "DRO_01", "id": 0},             "reqs": []}, #* HiddenPanel (StarPiece) -> Outpost 2 Exit West
    {"from": {"map": "DRO_02", "id": 0},             "to": {"map": "DRO_01", "id": "ItemA"},       "reqs": []}, #* Outpost 2 Exit West -> ItemA (Letter08)
    {"from": {"map": "DRO_02", "id": "ItemA"},       "to": {"map": "DRO_01", "id": 0},             "reqs": []}, #* ItemA (Letter08) -> Outpost 2 Exit West
]