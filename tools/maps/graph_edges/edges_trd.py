...
edges_trd = [
    ...
    {"from": {"map": "TRD_00", "id": "ChestA"}, "to": {"map": "TRD_00", "id": 3},        "reqs": []}, #* ChestA (Refund) -> Fortress Exterior Exit Bottom Left
    ...
    {"from": {"map": "TRD_01", "id": 2}, "to": {"map": "TRD_01", "id": 3}, "reqs": []}, #? Left Tower Exit Middle Right -> Left Tower Exit Top Right
    {"from": {"map": "TRD_01", "id": 3}, "to": {"map": "TRD_01", "id": 2}, "reqs": []}, #? Left Tower Exit Top Right -> Left Tower Exit Middle Right
    ...
    {"from": {"map": "TRD_02", "id": 1}, "to": {"map": "TRD_02", "id": 4}, "reqs": []}, #? Left Stairway Exit Bottom Right -> Left Stairway Exit Middle Right
    ...
    {"from": {"map": "TRD_02", "id": 3}, "to": {"map": "TRD_02", "id": 4}, "reqs": []}, #? Left Stairway Exit Top Right -> Left Stairway Exit Middle Right
    {"from": {"map": "TRD_02", "id": 4}, "to": {"map": "TRD_02", "id": 3}, "reqs": []}, #? Left Stairway Exit Middle Right -> Left Stairway Exit Top Right
    ...
    {"from": {"map": "TRD_03", "id": 2}, "to": {"map": "TRD_03", "id": 3}, "reqs": []}, #? Central Hall Exit Top Left -> Central Hall Exit Top Right
    {"from": {"map": "TRD_03", "id": 3}, "to": {"map": "TRD_03", "id": 2}, "reqs": []}, #? Central Hall Exit Top Right-> Central Hall Exit Top Left
    ...
    {"from": {"map": "TRD_03", "id": "ItemA"}, "to": {"map": "TRD_03", "id": 4},       "reqs": []}, #* ItemA (FortressKey) (Left) -> Central Hall Exit Left Cell
    ...
    {"from": {"map": "TRD_03", "id": 1},       "to": {"map": "TRD_03", "id": "ItemB"}, "reqs": []}, #* Central Hall Exit Bottom Right -> ItemB (FortressKey) (Right)
    ...
    {"from": {"map": "TRD_04", "id": 0}, "to": {"map": "TRD_04", "id": 5}, "reqs": []}, #? Right Starway Exit Middle Left -> Right Starway Exit Bottom Right
    {"from": {"map": "TRD_04", "id": 5}, "to": {"map": "TRD_04", "id": 0}, "reqs": []}, #? Right Starway Exit Bottom Right -> Right Starway Exit Middle Left
    ...
    {"from": {"map": "TRD_04", "id": 3}, "to": {"map": "TRD_04", "id": 1}, "reqs": []}, #? Right Starway Exit Top Right -> Right Starway Exit Middle Right
    ...
    {"from": {"map": "TRD_06", "id": 1}, "to": {"map": "TRD_06", "id": 0}, "reqs": []}, #? Jail Exit Left -> Jail Fall From Ceiling
    {"from": {"map": "TRD_06", "id": 0}, "to": {"map": "TRD_06", "id": 1}, "reqs": []}, #? Jail Fall From Ceiling -> Jail Exit Left
    ...
    {"from": {"map": "TRD_09", "id": 0},         "to": {"map": "TRD_09", "id": "YBlockA"}, "reqs": []}, #* Battlement Exit Left -> YBlockA (MapleSyrup)
