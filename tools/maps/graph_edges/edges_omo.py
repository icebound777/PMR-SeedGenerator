...
edges_omo = [
    ...
    {"from": {"map": "OMO_01", "id": 0},               "to": {"map": "OMO_01", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* BLU Large Playroom Exit East -> HiddenYBlockA (Mystery)
    {"from": {"map": "OMO_01", "id": "HiddenYBlockA"}, "to": {"map": "OMO_01", "id": 0},               "reqs": []}, #* HiddenYBlockA (Mystery) -> BLU Large Playroom Exit East
    {"from": {"map": "OMO_01", "id": 0},               "to": {"map": "OMO_01", "id": "HiddenYBlockB"}, "reqs": [require(partner="PARTNER_Watt")]}, #* BLU Large Playroom Exit East -> HiddenYBlockB (FrightJar)
    ...
    {"from": {"map": "OMO_02", "id": 0}, "to": {"map": "OMO_02", "id": 1}, "reqs": [require(partner="PARTNER_Bombette")]}, #? RED Boss Barricade Exit West -> RED Boss Barricade Exit East
    {"from": {"map": "OMO_02", "id": 1}, "to": {"map": "OMO_02", "id": 0}, "reqs": [require(partner="PARTNER_Bombette")]}, #? RED Boss Barricade Exit East -> RED Boss Barricade Exit West
    ...
    {"from": {"map": "OMO_02", "id": 1},               "to": {"map": "OMO_02", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* RED Boss Barricade Exit East -> HiddenYBlockA (Coin)
    ...
    {"from": {"map": "OMO_03", "id": 4},               "to": {"map": "OMO_03", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* BLU Station Spring to Toad Town -> HiddenYBlockA (StoneCap)
    ...
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemJ"},   "reqs": [require(hammer=0,boots=1),require(partner="PARTNER_Parakarry")]}, #* BLU Block City Exit West -> ItemJ (StarPiece) on building
    ...
    {"from": {"map": "OMO_05", "id": 1},               "to": {"map": "OMO_05", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* PNK Gourmet Guy Crossing Exit East (North) -> HiddenYBlockA (DizzyDial)
    ...
    {"from": {"map": "OMO_05", "id": 1},               "to": {"map": "OMO_05", "id": "HiddenYBlockB"}, "reqs": [require(partner="PARTNER_Watt")]}, #* PNK Gourmet Guy Crossing Exit East (North) -> HiddenYBlockB (SuperSoda)
    ...
    {"from": {"map": "OMO_06", "id": 1},               "to": {"map": "OMO_06", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* PNK Station Exit West (Switch Area) -> HiddenYBlockA (ThunderRage)
    ...
    {"from": {"map": "OMO_08", "id": 0},               "to": {"map": "OMO_08", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* GRN Station Exit East -> HiddenYBlockA (FireFlower)
    ...
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ItemA"},  "reqs": [require(partner="PARTNER_Bow"),require(partner="PARTNER_Parakarry")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemA (SuperSoda)
    {"from": {"map": "OMO_09", "id": "ItemA"},  "to": {"map": "OMO_09", "id": 0},        "reqs": []}, #* ItemA (SuperSoda) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ChestA"}, "reqs": [require(partner="PARTNER_Bow"),require(partner="PARTNER_Parakarry")]}, #* GRN Treadmills/Slot Machine Exit West -> ChestA (Dictionary)
    {"from": {"map": "OMO_09", "id": "ChestA"}, "to": {"map": "OMO_09", "id": 0},        "reqs": []}, #* ChestA (Dictionary) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ItemH"},  "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemH (StarPiece)
    {"from": {"map": "OMO_09", "id": "ItemH"},  "to": {"map": "OMO_09", "id": 0},        "reqs": []}, #* ItemH (StarPiece) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ItemO"},  "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemO (MysteryNote)
    ...
    # Starpiece Coins
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemI"}, "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemI (Coin)
    {"from": {"map": "OMO_09", "id": "ItemI"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemI (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemJ"}, "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemJ (Coin)
    {"from": {"map": "OMO_09", "id": "ItemJ"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemJ (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemK"}, "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemK (Coin)
    {"from": {"map": "OMO_09", "id": "ItemK"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemK (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemL"}, "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemL (Coin)
    {"from": {"map": "OMO_09", "id": "ItemL"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemL (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemM"}, "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemM (Coin)
    {"from": {"map": "OMO_09", "id": "ItemM"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemM (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemN"}, "reqs": [require(partner="PARTNER_Bow")]}, #* GRN Treadmills/Slot Machine Exit West -> ItemN (Coin)
    ...
    {"from": {"map": "OMO_10", "id": 0},               "to": {"map": "OMO_10", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* RED Station Exit West -> HiddenYBlockA (SuperShroom)
    ...
    {"from": {"map": "OMO_11", "id": 0},               "to": {"map": "OMO_11", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* RED Moving Platforms Exit West -> HiddenYBlockA (VoltShroom)
    {"from": {"map": "OMO_11", "id": "HiddenYBlockA"}, "to": {"map": "OMO_11", "id": 0},               "reqs": []}, #* HiddenYBlockA (VoltShroom) -> RED Moving Platforms Exit West
    {"from": {"map": "OMO_11", "id": 0},               "to": {"map": "OMO_11", "id": "HiddenYBlockB"}, "reqs": [require(partner="PARTNER_Watt")]}, #* RED Moving Platforms Exit West -> HiddenYBlockB (SnowmanDoll)
    ...
    {"from": {"map": "OMO_11", "id": 0},               "to": {"map": "OMO_11", "id": "HiddenRBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* RED Moving Platforms Exit West -> HiddenRBlockA (DeepFocus2)
    ...
    {"from": {"map": "OMO_13", "id": 0},               "to": {"map": "OMO_13", "id": "HiddenYBlockA"}, "reqs": [require(partner="PARTNER_Watt")]}, #* BLU Anti-Guy Hall Exit West -> HiddenYBlockA (MapleSyrup)
    ...
    {"from": {"map": "OMO_14", "id": 0}, "to": {"map": "OMO_14", "id": 1}, "reqs": [require(partner="PARTNER_Watt")]}, #? RED Boss Antechamber Exit West -> RED Boss Antechamber Exit East
