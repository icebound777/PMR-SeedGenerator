...
edges_omo = [
    ...
    {"from": {"map": "OMO_02", "id": 0}, "to": {"map": "OMO_02", "id": 1}, "reqs": []}, #? RED Boss Barricade Exit West -> RED Boss Barricade Exit East
    {"from": {"map": "OMO_02", "id": 1}, "to": {"map": "OMO_02", "id": 0}, "reqs": []}, #? RED Boss Barricade Exit East -> RED Boss Barricade Exit West
    ...
    {"from": {"map": "OMO_02", "id": 1},               "to": {"map": "OMO_02", "id": "HiddenYBlockA"}, "reqs": []}, #* RED Boss Barricade Exit East -> HiddenYBlockA (Coin)
    ...
    #TODO isn't the YBlockA invisible and should be a HiddenYBlock?
    ...
    {"from": {"map": "OMO_03", "id": 4}, "to": {"map": "OMO_03", "id": 2}, "reqs": []}, #? BLU Station Spring to Toad Town -> BLU Station Ride Train West
    {"from": {"map": "OMO_03", "id": 2}, "to": {"map": "OMO_03", "id": 4}, "reqs": []}, #? BLU Station Ride Train West -> BLU Station Spring to Toad Town
    {"from": {"map": "OMO_03", "id": 4}, "to": {"map": "OMO_03", "id": 3}, "reqs": []}, #? BLU Station Spring to Toad Town -> BLU Station Ride Train East
    {"from": {"map": "OMO_03", "id": 3}, "to": {"map": "OMO_03", "id": 4}, "reqs": []}, #? BLU Station Ride Train East -> BLU Station Spring to Toad Town
    
    {"from": {"map": "OMO_03", "id": 4},               "to": {"map": "OMO_03", "id": "HiddenPanel"},   "reqs": []}, #* BLU Station Spring to Toad Town -> HiddenPanel (StarPiece)
    {"from": {"map": "OMO_03", "id": "HiddenPanel"},   "to": {"map": "OMO_03", "id": 4},               "reqs": []}, #* HiddenPanel (StarPiece) -> BLU Station Spring to Toad Town
    {"from": {"map": "OMO_03", "id": 4},               "to": {"map": "OMO_03", "id": "HiddenYBlockA"}, "reqs": []}, #* BLU Station Spring to Toad Town -> HiddenYBlockA (StoneCap)
    ...
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemA"},   "reqs": []}, #* BLU Block City Exit West -> ItemA (Mushroom)
    {"from": {"map": "OMO_04", "id": "ItemA"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemA (Mushroom) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ChestA"},  "reqs": []}, #* BLU Block City Exit West -> ChestA (StoreroomKey)
    {"from": {"map": "OMO_04", "id": "ChestA"},  "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ChestA (StoreroomKey) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "YBlockA"}, "reqs": []}, #* BLU Block City Exit West -> YBlockA (Coin)
    {"from": {"map": "OMO_04", "id": "YBlockA"}, "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* YBlockA (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "YBlockB"}, "reqs": []}, #* BLU Block City Exit West -> YBlockB (Coin)
    {"from": {"map": "OMO_04", "id": "YBlockB"}, "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* YBlockB (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "YBlockC"}, "reqs": []}, #* BLU Block City Exit West -> YBlockC (ThunderBolt)
    {"from": {"map": "OMO_04", "id": "YBlockC"}, "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* YBlockC (ThunderBolt) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemB"},   "reqs": []}, #* BLU Block City Exit West -> ItemB (Coin)
    {"from": {"map": "OMO_04", "id": "ItemB"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemB (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemC"},   "reqs": []}, #* BLU Block City Exit West -> ItemC (Coin)
    {"from": {"map": "OMO_04", "id": "ItemC"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemC (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemD"},   "reqs": []}, #* BLU Block City Exit West -> ItemD (Coin)
    {"from": {"map": "OMO_04", "id": "ItemD"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemD (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemE"},   "reqs": []}, #* BLU Block City Exit West -> ItemE (Coin)
    {"from": {"map": "OMO_04", "id": "ItemE"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemE (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemF"},   "reqs": []}, #* BLU Block City Exit West -> ItemF (Coin)
    {"from": {"map": "OMO_04", "id": "ItemF"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemF (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemG"},   "reqs": []}, #* BLU Block City Exit West -> ItemG (Coin)
    {"from": {"map": "OMO_04", "id": "ItemG"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemG (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemH"},   "reqs": []}, #* BLU Block City Exit West -> ItemH (Coin)
    {"from": {"map": "OMO_04", "id": "ItemH"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemH (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemI"},   "reqs": []}, #* BLU Block City Exit West -> ItemI (Coin)
    {"from": {"map": "OMO_04", "id": "ItemI"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemI (Coin) -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemJ"},   "reqs": []}, #* BLU Block City Exit West -> ItemJ (StarPiece) on building
    {"from": {"map": "OMO_04", "id": "ItemJ"},   "to": {"map": "OMO_04", "id": 0},         "reqs": []}, #* ItemJ (StarPiece) on building -> BLU Block City Exit West
    {"from": {"map": "OMO_04", "id": 0},         "to": {"map": "OMO_04", "id": "ItemK"},   "reqs": []}, #* BLU Block City Exit West -> ItemK (StarPiece)
    ...
    {"from": {"map": "OMO_05", "id": 0}, "to": {"map": "OMO_05", "id": 1}, "reqs": []}, #? PNK Gourmet Guy Crossing Exit East (South) -> PNK Gourmet Guy Crossing Exit East (North)
    ...
    {"from": {"map": "OMO_05", "id": 1},               "to": {"map": "OMO_05", "id": "HiddenYBlockA"}, "reqs": []}, #* PNK Gourmet Guy Crossing Exit East (North) -> HiddenYBlockA (DizzyDial)
    ...
    {"from": {"map": "OMO_05", "id": 1},               "to": {"map": "OMO_05", "id": "HiddenYBlockB"}, "reqs": []}, #* PNK Gourmet Guy Crossing Exit East (North) -> HiddenYBlockB (SuperSoda)
    ...
    {"from": {"map": "OMO_06", "id": 0},               "to": {"map": "OMO_06", "id": "HiddenPanel"},   "reqs": []}, #* PNK Station Exit West -> HiddenPanel (StarPiece)
    ...
    {"from": {"map": "OMO_06", "id": 1},               "to": {"map": "OMO_06", "id": "HiddenYBlockA"}, "reqs": []}, #* PNK Station Exit West (Switch Area) -> HiddenYBlockA (ThunderRage)
    ...
    {"from": {"map": "OMO_07", "id": 0},         "to": {"map": "OMO_07", "id": "ItemA"},   "reqs": []}, #* PNK Playhouse Exit West -> ItemA (ThunderRage)
    {"from": {"map": "OMO_07", "id": "ItemA"},   "to": {"map": "OMO_07", "id": 0},         "reqs": []}, #* ItemA (ThunderRage) -> PNK Playhouse Exit West
    {"from": {"map": "OMO_07", "id": 0},         "to": {"map": "OMO_07", "id": "ChestA"},  "reqs": []}, #* PNK Playhouse Exit West -> ChestA (FryingPan)
    {"from": {"map": "OMO_07", "id": "ChestA"},  "to": {"map": "OMO_07", "id": 0},         "reqs": []}, #* ChestA (FryingPan) -> PNK Playhouse Exit West
    {"from": {"map": "OMO_07", "id": 0},         "to": {"map": "OMO_07", "id": "ChestB"},  "reqs": []}, #* PNK Playhouse Exit West -> ChestB (DefendPlusA)
    {"from": {"map": "OMO_07", "id": "ChestB"},  "to": {"map": "OMO_07", "id": 0},         "reqs": []}, #* ChestB (DefendPlusA) -> PNK Playhouse Exit West
    {"from": {"map": "OMO_07", "id": 0},         "to": {"map": "OMO_07", "id": "ChestC"},  "reqs": []}, #* PNK Playhouse Exit West -> ChestC (IcePower)
    {"from": {"map": "OMO_07", "id": "ChestC"},  "to": {"map": "OMO_07", "id": 0},         "reqs": []}, #* ChestC (IcePower) -> PNK Playhouse Exit West
    {"from": {"map": "OMO_07", "id": 0},         "to": {"map": "OMO_07", "id": "YBlockA"}, "reqs": []}, #* PNK Playhouse Exit West -> YBlockA (Coin)
    ...
    {"from": {"map": "OMO_08", "id": 0},               "to": {"map": "OMO_08", "id": "HiddenPanel"},   "reqs": []}, #* GRN Station Exit East -> HiddenPanel (StarPiece)
    {"from": {"map": "OMO_08", "id": "HiddenPanel"},   "to": {"map": "OMO_08", "id": 0},               "reqs": []}, #* HiddenPanel (StarPiece) -> GRN Station Exit East
    {"from": {"map": "OMO_08", "id": 0},               "to": {"map": "OMO_08", "id": "HiddenYBlockA"}, "reqs": []}, #* GRN Station Exit East -> HiddenYBlockA (FireFlower)
    ...
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ItemA"},  "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemA (SuperSoda)
    {"from": {"map": "OMO_09", "id": "ItemA"},  "to": {"map": "OMO_09", "id": 0},        "reqs": []}, #* ItemA (SuperSoda) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ChestA"}, "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ChestA (Dictionary)
    {"from": {"map": "OMO_09", "id": "ChestA"}, "to": {"map": "OMO_09", "id": 0},        "reqs": []}, #* ChestA (Dictionary) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ItemH"},  "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemH (StarPiece)
    {"from": {"map": "OMO_09", "id": "ItemH"},  "to": {"map": "OMO_09", "id": 0},        "reqs": []}, #* ItemH (StarPiece) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},        "to": {"map": "OMO_09", "id": "ItemO"},  "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemO (MysteryNote)
    ...
    # Starpiece Coins
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemI"}, "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemI (Coin)
    {"from": {"map": "OMO_09", "id": "ItemI"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemI (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemJ"}, "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemJ (Coin)
    {"from": {"map": "OMO_09", "id": "ItemJ"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemJ (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemK"}, "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemK (Coin)
    {"from": {"map": "OMO_09", "id": "ItemK"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemK (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemL"}, "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemL (Coin)
    {"from": {"map": "OMO_09", "id": "ItemL"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemL (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemM"}, "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemM (Coin)
    {"from": {"map": "OMO_09", "id": "ItemM"}, "to": {"map": "OMO_09", "id": 0},       "reqs": []}, #* ItemM (Coin) -> GRN Treadmills/Slot Machine Exit West
    {"from": {"map": "OMO_09", "id": 0},       "to": {"map": "OMO_09", "id": "ItemN"}, "reqs": []}, #* GRN Treadmills/Slot Machine Exit West -> ItemN (Coin)
    ...
    {"from": {"map": "OMO_10", "id": 0},               "to": {"map": "OMO_10", "id": "HiddenPanel"},   "reqs": []}, #* RED Station Exit West -> HiddenPanel (StarPiece)
    {"from": {"map": "OMO_10", "id": "HiddenPanel"},   "to": {"map": "OMO_10", "id": 0},               "reqs": []}, #* HiddenPanel (StarPiece) -> RED Station Exit West
    {"from": {"map": "OMO_10", "id": 0},               "to": {"map": "OMO_10", "id": "HiddenYBlockA"}, "reqs": []}, #* RED Station Exit West -> HiddenYBlockA (SuperShroom)
    ...
    {"from": {"map": "OMO_11", "id": 0},               "to": {"map": "OMO_11", "id": "HiddenYBlockA"}, "reqs": []}, #* RED Moving Platforms Exit West -> HiddenYBlockA (VoltShroom)
    {"from": {"map": "OMO_11", "id": "HiddenYBlockA"}, "to": {"map": "OMO_11", "id": 0},               "reqs": []}, #* HiddenYBlockA (VoltShroom) -> RED Moving Platforms Exit West
    {"from": {"map": "OMO_11", "id": 0},               "to": {"map": "OMO_11", "id": "HiddenYBlockB"}, "reqs": []}, #* RED Moving Platforms Exit West -> HiddenYBlockB (SnowmanDoll)
    ...
    {"from": {"map": "OMO_11", "id": 0},               "to": {"map": "OMO_11", "id": "HiddenRBlockA"}, "reqs": []}, #* RED Moving Platforms Exit West -> HiddenRBlockA (DeepFocus2)
    ...
    {"from": {"map": "OMO_13", "id": 0},               "to": {"map": "OMO_13", "id": "HiddenYBlockA"}, "reqs": []}, #* BLU Anti-Guy Hall Exit West -> HiddenYBlockA (MapleSyrup)
