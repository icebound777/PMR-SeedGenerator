...
edges_sbk = [
    ...
    {"from": {"map": "SBK_10", "id": 1},               "to": {"map": "SBK_10", "id": "HiddenYBlockA"}, "reqs": [require(partner="Watt")]}, #* N2W3 Exit East -> HiddenYBlockA (ThunderRage)
    ...
    {"from": {"map": "SBK_24", "id": 0},               "to": {"map": "SBK_24", "id": "HiddenRBlockA"}, "reqs": [require(partner="Watt")]}, #* N1E1 Palm Trio Exit West -> HiddenRBlockA (RunawayPay)
    ...
    {"from": {"map": "SBK_45", "id": 0},       "to": {"map": "SBK_45", "id": "ItemA"}, "reqs": [require(boots=2,partner="Kooper")]}, #* S1E2 Small Bluffs Exit West -> ItemA (StopWatch)
    ...
    {"from": {"map": "SBK_46", "id": 0},               "to": {"map": "SBK_46", "id": "HiddenYBlockA"}, "reqs": [require(partner="Watt")]}, #* S1E3 North of Oasis Exit West -> HiddenYBlockA (LifeShroom)
    ...
    {"from": {"map": "SBK_61", "id": 0},               "to": {"map": "SBK_61", "id": "HiddenRBlockA"}, "reqs": [require(partner="Watt")]}, #* S3W2 Hidden AttackFX Exit West -> HiddenRBlockA (AttackFXC)
