...
edges_dgb = [
    ...
    {"from": {"map": "DGB_01", "id": 0}, "to": {"map": "DGB_01", "id": 1}, "reqs": []}, #? Great Hall Door 1F Bottom -> Great Hall Door Door 1F Left
    {"from": {"map": "DGB_01", "id": 1}, "to": {"map": "DGB_01", "id": 0}, "reqs": []}, #? Great Hall Door Door 1F Left -> Great Hall Door 1F Bottom
    {"from": {"map": "DGB_01", "id": 0}, "to": {"map": "DGB_01", "id": 2}, "reqs": []}, #? Great Hall Door 1F Bottom -> Great Hall Door Door 1F Right
    ...
    {"from": {"map": "DGB_03", "id": 3}, "to": {"map": "DGB_03", "id": 5}, "reqs": []}, #? Table/Clock Room (1/2F) Door 2F Far Left -> Table/Clock Room (1/2F) 2F Behind The Clock
    {"from": {"map": "DGB_03", "id": 5}, "to": {"map": "DGB_03", "id": 3}, "reqs": []}, #? Table/Clock Room (1/2F) 2F Behind The Clock -> Table/Clock Room (1/2F) Door 2F Far Left
    
    {"from": {"map": "DGB_03", "id": 3},       "to": {"map": "DGB_03", "id": "ItemA"}, "reqs": []}, #* Table/Clock Room (1/2F) Door 2F Far Left -> ItemA (StarPiece)
    ...
    {"from": {"map": "DGB_08", "id": 0}, "to": {"map": "DGB_08", "id": 1}, "reqs": []}, #? East Hall (1/2F) Door 1F Left -> East Hall (1/2F) Door 2F Left
    ...
    {"from": {"map": "DGB_11", "id": 2},       "to": {"map": "DGB_11", "id": "ItemA"}, "reqs": []}, #* Covered Tables Room (1F) Top Right Ceiling Hole -> ItemA (DDownJump)
    ...
    {"from": {"map": "DGB_12", "id": 0},        "to": {"map": "DGB_12", "id": "ChestA"}, "reqs": []}, #* Spike Trap Room (2F) Door Bottom Left -> ChestA (CastleKey1)
    ...
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemA"}, "reqs": []}, #* Hidden Bedroom (2F) Door Bottom -> ItemA (MegaRush)
    {"from": {"map": "DGB_13", "id": "ItemA"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemA (MegaRush) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemB"}, "reqs": []}, #* Hidden Bedroom (2F) Door Bottom -> ItemB (Coin)
    {"from": {"map": "DGB_13", "id": "ItemB"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemB (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemC"}, "reqs": []}, #* Hidden Bedroom (2F) Door Bottom -> ItemC (Coin)
    {"from": {"map": "DGB_13", "id": "ItemC"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemC (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemD"}, "reqs": []}, #* Hidden Bedroom (2F) Door Bottom -> ItemD (Coin)
    {"from": {"map": "DGB_13", "id": "ItemD"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemD (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemE"}, "reqs": []}, #* Hidden Bedroom (2F) Door Bottom -> ItemE (Coin)
    {"from": {"map": "DGB_13", "id": "ItemE"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemE (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemF"}, "reqs": []}, #* Hidden Bedroom (2F) Door Bottom -> ItemF (Coin)
    {"from": {"map": "DGB_13", "id": "ItemF"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemF (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemG"}, "reqs": []}, #* Hidden Bedroom (2F) Door Bottom -> ItemG (Coin)
