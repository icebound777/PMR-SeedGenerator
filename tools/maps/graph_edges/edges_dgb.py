...
edges_dgb = [
    ...
    {"from": {"map": "DGB_01", "id": 2}, "to": {"map": "DGB_08", "id": 0}, "reqs": []}, # Great Hall Door Door 1F Right -> East Hall (1/2F) Door 1F Left
    ...
    {"from": {"map": "DGB_01", "id": 0}, "to": {"map": "DGB_01", "id": 2}, "reqs": [require(item="CastleKey1",partner="PARTNER_BOW")]}, #? Great Hall Door 1F Bottom -> Great Hall Door Door 1F Right
    ...
    {"from": {"map": "DGB_03", "id": 3}, "to": {"map": "DGB_14", "id": 0}, "reqs": []}, # Table/Clock Room (1/2F) Door 2F Far Left -> Stairs to Third Floor Door Bottom Right
    ...
    {"from": {"map": "DGB_03", "id": 4}, "to": {"map": "DGB_03", "id": 3}, "reqs": [require(item="CastleKey1")]}, #? Table/Clock Room (1/2F) Door 2F Far Right -> Table/Clock Room (1/2F) Door 2F Far Left
    ...
    {"from": {"map": "DGB_06", "id": "ChestA"}, "to": {"map": "DGB_06", "id": 1},        "reqs": []}, #* ChestA (CastleKey1) -> Basement Fall From Ceiling
    ...
    {"from": {"map": "DGB_08", "id": 0}, "to": {"map": "DGB_08", "id": 1}, "reqs": [require(partner="PARTNER_Bow")]}, #? East Hall (1/2F) Door 1F Left -> East Hall (1/2F) Door 2F Left
    ...
    {"from": {"map": "DGB_09", "id": 3}, "to": {"map": "DGB_10", "id": 0}, "reqs": []}, # West Hall (2F) Cracked Wall -> Sealed Room (2F) Cracked Wall Bottom Left
    ...
    {"from": {"map": "DGB_09", "id": 0}, "to": {"map": "DGB_09", "id": 3}, "reqs": [require(partner="PARTNER_Bombette")]}, #? West Hall (2F) Door Far Left -> West Hall (2F) Cracked Wall
    ...
    {"from": {"map": "DGB_10", "id": 1}, "to": {"map": "DGB_11", "id": 3}, "reqs": []}, # Sealed Room (2F) Top Left Hole -> Covered Tables Room (1F) Spring To Ceiling
    ...
    {"from": {"map": "DGB_11", "id": 3}, "to": {"map": "DGB_10", "id": 1}, "reqs": []}, # Covered Tables Room (1F) Spring To Ceiling -> Sealed Room (2F) Top Left Hole
    ...
    {"from": {"map": "DGB_11", "id": 2},       "to": {"map": "DGB_11", "id": "ItemA"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Covered Tables Room (1F) Top Right Ceiling Hole -> ItemA (DDownJump)
    ...
    {"from": {"map": "DGB_12", "id": 0},        "to": {"map": "DGB_12", "id": "ChestA"}, "reqs": [require(partner="PARTNER_Bow")]}, #* Spike Trap Room (2F) Door Bottom Left -> ChestA (CastleKey1)
    ...
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemA"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Hidden Bedroom (2F) Door Bottom -> ItemA (MegaRush)
    {"from": {"map": "DGB_13", "id": "ItemA"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemA (MegaRush) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemB"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Hidden Bedroom (2F) Door Bottom -> ItemB (Coin)
    {"from": {"map": "DGB_13", "id": "ItemB"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemB (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemC"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Hidden Bedroom (2F) Door Bottom -> ItemC (Coin)
    {"from": {"map": "DGB_13", "id": "ItemC"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemC (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemD"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Hidden Bedroom (2F) Door Bottom -> ItemD (Coin)
    {"from": {"map": "DGB_13", "id": "ItemD"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemD (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemE"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Hidden Bedroom (2F) Door Bottom -> ItemE (Coin)
    {"from": {"map": "DGB_13", "id": "ItemE"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemE (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemF"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Hidden Bedroom (2F) Door Bottom -> ItemF (Coin)
    {"from": {"map": "DGB_13", "id": "ItemF"}, "to": {"map": "DGB_13", "id": 0},       "reqs": []}, #* ItemF (Coin) -> Hidden Bedroom (2F) Door Bottom
    {"from": {"map": "DGB_13", "id": 0},       "to": {"map": "DGB_13", "id": "ItemG"}, "reqs": [require(partner="PARTNER_Parakarry")]}, #* Hidden Bedroom (2F) Door Bottom -> ItemG (Coin)
    ...
    {"from": {"map": "DGB_14", "id": "YBlockA"}, "to": {"map": "DGB_14", "id": 0},         "reqs": []}, #* YBlockA (MapleSyrup) -> Stairs to Third Floor Door Bottom Right
    ...
    {"from": {"map": "DGB_15", "id": 0}, "to": {"map": "DGB_15", "id": 1}, "reqs": [require(item="CastleKey1")]}, #? West Hall (3F) Door Far Left -> West Hall (3F) Door Far Right
    ...
    {"from": {"map": "DGB_16", "id": 0},       "to": {"map": "DGB_16", "id": "ItemA"}, "reqs": []}, #* Sleeping Clubbas Room (3F) Door Bottom Right -> ItemA (CastleKey1)
    {"from": {"map": "DGB_16", "id": "ItemA"}, "to": {"map": "DGB_16", "id": 0},       "reqs": []}, #* ItemA (CastleKey1) -> Sleeping Clubbas Room (3F) Door Bottom Right
