...
edges_flo = [
    ...
    {"from": {"map": "FLO_16", "id": 0}, "to": {"map": "FLO_16", "id": 1}, "reqs": []}, #? (NE) Elevators Exit Left -> (NE) Elevators Exit Right
    {"from": {"map": "FLO_16", "id": 1}, "to": {"map": "FLO_16", "id": 0}, "reqs": []}, #? (NE) Elevators Exit Right -> (NE) Elevators Exit Left
    ...
    {"from": {"map": "FLO_22", "id": 0},       "to": {"map": "FLO_22", "id": "ItemA"}, "reqs": []}, #* (East) Old Well Exit Left -> ItemA (FLowerSaverB)
    ...
    {"from": {"map": "FLO_23", "id": 0}, "to": {"map": "FLO_23", "id": 1}, "reqs": []}, #? (West) Path to Maze Exit Right -> (West) Path to Maze Exit Left
    ...
    {"from": {"map": "FLO_12", "id": 0},       "to": {"map": "FLO_12", "id": "GiftA"}, "reqs": []}, #* (West) Rosie's Trellis Exit Right -> GiftA (WaterStone)
    ...
    {"from": {"map": "FLO_14", "id": 0}, "to": {"map": "FLO_14", "id": 1}, "reqs": []}, #? (NW) Bubble Flower Exit Right -> (NW) Bubble Flower Exit Left
    ...
    {"from": {"map": "FLO_13", "id": 0},       "to": {"map": "FLO_13", "id": "ItemA"}, "reqs": []}, #* (NW) Lakilester Exit Right -> ItemA (MegaSmash)
